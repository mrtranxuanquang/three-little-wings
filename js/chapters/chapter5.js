...
export const CHAPTER_5 = {
  ...
  triggers: [
    ...
    { id: 'cave_exit',    type: 'onEnter', x: 2550, w: 80, once: true, event: 'exit_cave' },
  ...
  events: {
    ...
    deer_reveal: [
      ...
      { t: 4000, cmd: 'charState', char: 'choe',  state: 'idle' },
      { t: 4000, cmd: 'charState', char: 'cucu',  state: 'idle' },
      { t: 4000, cmd: 'charState', char: 'chien', state: 'idle' },
      { t: 4200, cmd: 'setCaveWalk', on: true },
      { t: 4200, cmd: 'releaseInput' },
    ],
